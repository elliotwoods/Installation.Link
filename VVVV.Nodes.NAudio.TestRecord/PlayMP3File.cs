...
{
    #region PluginInfo
    [PluginInfo(Name = "PlayMP3File", Category = "NAudio", Help = "Play wav files through WASAPI devices", Tags = "")]
    #endregion PluginInfo
    public class NAudioPlayMP3FileNode : IPluginEvaluate
    {
        #region fields
        ...
        public NAudioPlayMP3FileNode(IPluginHost host)
        {
            //assign host
            this.FHost = host;
        ...
        {
            WaveStream readerStream = new Mp3FileReader(fileName);
            ...
            //if (readerStream.WaveFormat.Channels == 4)
            //{
            //    //if (readerStream.WaveFormat.BitsPerSample == 32)
            //    //{
            //    //    //readerStream = WaveFormatConversionStream.CreatePcmStream(readerStream);
            //    //    readerStream = new QuadToStereoStream32(readerStream);
            //    //} 
            //    //else
            //        throw (new Exception("We don't handle this format"));
            //}
